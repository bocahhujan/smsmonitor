...
try:
    ...
    import resources
    from tabs.mysqlcoonect import MysqlcoonectWidget
    from tabs.basicinfo import BasicInfoWidget
    from tabs.logsms import LogsmsWidget
...
class MainWindow(QMainWindow):
    ...
    def __init__(self, parent=None):
        ...
        self.terminal = TerminalWidget(MysqlcoonectWidget())
        ...
        self.main_tabs.addTab(MysqlcoonectWidget(),self.tr(MysqlcoonectWidget.TITLE))
        self.main_tabs.addTab(BasicInfoWidget(self.terminal), self.tr(BasicInfoWidget.TITLE))
        self.main_tabs.addTab(LogsmsWidget(self.terminal), self.tr(LogsmsWidget.TITLE))
    ...
    def show_about(self):
        ...
        message = '''<font size="+2">%s</font> v%s
                     <p>GUI for Monitor SMS from WAFCOME.
                     <p>Written by %s
                     <br>&copy; %s''' % (APP_NAME,__version__,AUTHOR,COPYRIGHT)
